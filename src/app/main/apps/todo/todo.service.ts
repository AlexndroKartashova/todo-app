...
export class TodoService implements Resolve<any>
{
    ...
    /*getItems(): void {
        //this.categoryService.onCategoriesChanged.subscribe(categoryId => {
            //if (categoryId != null) {
                this.itemService.getItems(categoryId).subscribe((items) => {
                    this.todos = items;
                    // this.unBlockedAddItem = false;
                }) 
